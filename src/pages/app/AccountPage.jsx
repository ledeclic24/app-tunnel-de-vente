...
export default function AccountPage() {
  ...
  return (
    <div className="max-w-lg">
      <GradientBanner icon={User} title="Mon compte" className="mb-6" />

      <form onSubmit={handleSave} className="bg-background border border-surface/10 rounded-[2rem] p-6 md:p-8 shadow-soft space-y-4 mb-6">
        <div>
      ...
      <form onSubmit={handlePasswordSave} className="bg-background border border-surface/10 rounded-[2rem] p-6 md:p-8 shadow-soft space-y-4 mb-6">
